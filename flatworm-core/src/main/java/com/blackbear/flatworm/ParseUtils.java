...
public class ParseUtils {
     ...
     * @throws FlatwormCreatorException should creating the new instance fail for any reason.
     */
    ...
    /**
     * Determine how best to add the {@code toAdd} instance to the collection found in {@code target} by seeing if
     * either the {@code Segment.addMethod} has a value or if {@code Segement.collectionPropertyName} has a value. If neither
     * values exist then no action is taken.
     ...
     * @throws FlatwormCreatorException should the attempt to add the {@code toAdd} instance to the specified collection fail
     * for any reason.
     */
    public static void addValueToCollection(SegmentElement segment, Object target, Object toAdd) throws FlatwormCreatorException {
    ...
    /**
     * Invoke an add method on the {@code target} instance by the {@code methodName} and pass it the {@code toAdd} instance to
     * add.
     ...
     * @throws FlatwormCreatorException should invoking the method fail for any reason.
     */
     ...
     *                               null value a {@link FlatwormCreatorException} will be thrown.
     * @param toAdd                  The instance to add to the collection indicated.
     * @throws FlatwormCreatorException Should the underlying collection referenced by {@code collectionPropertyName} be {@code null} or
     *                                  non-existent, should no {@code add(Object)} method exist on the collection and should any error
     *                                  occur while invoking the {@code add(Object)} method if it is found (reflection style errors).
     */
    public static void addValueToCollection(Object target, String collectionPropertyName, Object toAdd) throws FlatwormCreatorException {
